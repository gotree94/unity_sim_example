...
3. **"Official Releases"** 탭에서 **"LTS"** (Long Term Support) 버전을 선택합니다.
   - **추천 버전**: `Unity 2022.3.x LTS` (가장 안정적)
   - LTS 버전은 최소 2년간 업데이트와 보안 패치를 지원합니다.

> ⚠️ **중요**: 이 튜토리얼은 **Unity 2022.3 LTS** 버전을 기준으로 작성되었습니다.  
> 다른 버전을 사용하면 일부 메뉴나 기능이 다를 수 있습니다.
