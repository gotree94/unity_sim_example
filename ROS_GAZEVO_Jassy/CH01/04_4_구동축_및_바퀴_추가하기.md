...
> ※ joint_state_publisher_gui는 ROS에서 로봇 모델의 관절(Joint) 상태 값을 시각적으로 쉽게 조작할 수 있도록 제공하는 도구입니다. <br> 사용자는 슬라이더나 입력 창을 통해 각 관절의 각도나 위치 값을 실시간으로 변경할 수 있으며, 이 변화는 RViz 같은 시각화 도구에 즉시 반영됩니다. <br> 로봇의 관절 움직임 범위를 확인하고 URDF 모델이 정상적으로 작동하는지 디버깅하거나 기구학적 자세를 확인하는 데 유용하게 사용됩니다. <br> 실제 로봇 구동 시, 관절 상태(joint states)는 로봇으로부터 전달되며, 이 경우 joint_state_publisher_gui는 사용하지 않습니다.

### 6. 표시되는 것을 확인합니다.

![조인트 시각화](../img/image85.bmp) ![바퀴 축 회전 테스트](../img/image86.bmp)

### 7. joint_state_publisher_gui를 이용해 바퀴 축을 돌려 봅니다.

![z축 기준 회전](../img/image87.bmp) ![바퀴 축 회전 테스트](../img/image86.bmp)
...
![](../img/image83.bmp) ![](../img/image92.bmp)

### 11. joint_state_publisher_gui를 이용해 바퀴 축을 돌려 봅니다.

![](../img/image89.bmp) ![](../img/image92.bmp)
...
![](../img/image91.bmp) ![회전축 방향 수정](../img/image88.bmp)
...
![](../img/image94.bmp) ![](../img/image95.bmp)
