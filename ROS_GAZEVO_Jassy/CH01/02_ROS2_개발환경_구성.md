...
![cmd 검색](../img/image3.bmp)

2. [명령 프롬프트]를 관리자 권한으로 실행합니다.

![명령 프롬프트 관리자 실행](../img/image4.bmp)
...
| `--no-distribution` | 리눅스 배포판은 설치하지 않고 WSL 기능만 설치. WSL의 런타임(커널, 실행 환경)은 깔리지만, Ubuntu 같은 Linux OS는 포함되지 않음. |

![WSL 설치](../img/image5.bmp)
...
![Docker 검색](../img/image6.bmp)

2. 다음 사이트로 들어갑니다.

![Docker 사이트](../img/image7.bmp)

3. 다음 버튼을 클릭하여 프로그램을 다운로드합니다.

![Docker 다운로드](../img/image8.bmp)

4. 기본 상태로 설치를 진행합니다.

![Docker 설치](../img/image9.bmp)

5. 설치 마지막 창에서 [Close and restart] 버튼을 눌러 컴퓨터를 재부팅합니다.

![Docker 재부팅](../img/image10.bmp)
