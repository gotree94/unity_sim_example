...
1. GUI 창 상단의 **연결 상태**가 **"연결됨"** (초록색)으로 표시되는지 확인합니다.
2. Unity Console에는 `[TCPServer] 클라이언트 연결됨! (현재 1개)` 메시지가 나타납니다.

#### 4단계: 로봇 제어

GUI 창의 **버튼을 클릭**하면 Unity의 로봇이 움직입니다!
...
> 💡 **팁**: 버튼을 클릭하면 로그 영역에 전송된 명령이 표시됩니다.
